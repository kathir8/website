...
export class AppComponent {
  OtherProducts: ProductAllDetails[] = [
    ...
    { id: 2, image: 'images/products/Laptop.png', title: 'Macbook', description: '2020 Apple MacBook Air Laptop: Apple M1 Chip, 13” Retina Display, 8GB RAM, 256GB SSD Storage, Backlit Keyboard, FaceTime HD Camera, Touch ID. Works with iPhone/iPad; Silver', oldPrice: '$1024.99+', newPrice: '$999.99+', offer: '12%', rating: '4.0', userCount: '120' },
    ...
    { id: 4, image: 'images/products/Laptop.png', title: 'Macbook', description: '2020 Apple MacBook Air Laptop: Apple M1 Chip, 13” Retina Display, 8GB RAM, 256GB SSD Storage, Backlit Keyboard, FaceTime HD Camera, Touch ID. Works with iPhone/iPad; Silver', oldPrice: '$1024.99+', newPrice: '$999.99+', offer: '6%', rating: '5.3', userCount: '113' },
    { id: 5, image: 'images/products/Laptop.png', title: 'Macbook', description: '2020 Apple MacBook Air Laptop: Apple M1 Chip, 13” Retina Display, 8GB RAM, 256GB SSD Storage, Backlit Keyboard, FaceTime HD Camera, Touch ID. Works with iPhone/iPad; Silver', oldPrice: '$1024.99+', newPrice: '$999.99+', offer: '10%', rating: '3.0', userCount: '12' },
    ...
    { id: 7, image: 'images/products/Laptop.png', title: 'Macbook', description: '2020 Apple MacBook Air Laptop: Apple M1 Chip, 13” Retina Display, 8GB RAM, 256GB SSD Storage, Backlit Keyboard, FaceTime HD Camera, Touch ID. Works with iPhone/iPad; Silver', oldPrice: '$1024.99+', newPrice: '$999.99+', offer: '4%', rating: '4.5', userCount: '103' },
